      ...
      {isReviewBlurred && (
        <div className="absolute inset-0 bg-black/70 backdrop-blur-md flex flex-col items-center justify-center text-center p-8 rounded-2xl">
          ...
          <p className="text-gray-400 mb-6 max-w-sm">
            Register this audit on the Somnia Testnet to permanently store the results and receive a verifiable proof-of-audit.
          </p>
          <div className="w-full max-w-xs">
            ...
            {!isCorrectNetwork && isConnected && (
              <div className="mt-4 text-yellow-400 text-sm">
                Please switch to Somnia Testnet to register.
              </div>
            )}
          </div>
        </div>
